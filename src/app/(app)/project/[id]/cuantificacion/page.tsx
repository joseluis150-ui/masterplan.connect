    ...
    <div className="space-y-6">
      ...
      {selected.size > 0 && (
        <div className="flex items-center gap-2 px-3 py-2 rounded-md bg-[#0A0A0A] text-white shadow-md">
          ...
          {/* La asignación a paquetes se mudó al módulo de Paquetes —
              ahora se asigna a nivel de insumo (no de línea de
              cuantificación), porque una compra real es de "Cemento",
              no de "Cemento del artículo Hormigón H21". Andá al detalle
              del paquete y usá el tab "Asignar insumos". */}
          <Button
            size="sm"
            variant="ghost"
